...
def export_freedom_conference_registrations_csv(request):
    """
    Staff-only CSV export of all Freedom Conference registrations.
    """
    qs = FreedomConferenceRegistration.objects.all().order_by("-created_at")
